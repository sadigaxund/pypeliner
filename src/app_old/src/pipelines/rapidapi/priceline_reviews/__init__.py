...
from src.templates.Statistics import PRICELINE_REVIEWS_STATISTICS as STATISTICS

Config(PAGE_SIZE=500)
Config(CODE_NAME='priceline_reviews')
...
if __name__ == "src.extract.rapidapi.priceline_reviews":
    atexit.register(destructor)
    constructor(script_title="Priceline Reviews Extractor",
